        ...
        <div className="relative z-10 max-w-lg space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed text-white/60">
              PDV, estoque, financeiro, NF-e e CRM em um sistema único — projetado para conveniências, distribuidoras e adegas que não podem perder tempo.
            </p>
          </div>

          {/* mockup */}
          <div className="relative rounded-xl border border-white/10 bg-white/[0.03] p-1 backdrop-blur-sm">
            <div className="rounded-lg bg-[oklch(0.18_0.02_260)] p-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  <div key={k.l} className="rounded-md bg-white/[0.04] p-2.5">
              ...
              <div className="mt-3 h-16 rounded-md bg-gradient-to-t from-primary/30 to-transparent" />
